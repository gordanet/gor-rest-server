...
from endpoints import get_balance, get_utxos, get_blocks, get_blockdag, get_circulating_supply, get_gord_info, \
...
from endpoints.gord_requests.submit_transaction_request import submit_a_new_transaction
from helper import get_gor_market_data
...
print(
    ...
    f"{get_gord_info}, {get_network}, {get_marketcap}, {get_hashrate}, {get_blockreward}"
